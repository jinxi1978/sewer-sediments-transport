...
//added by jinxi
//管道冲淤计算公式中V^3/(gRω)与k、m之间的数值关系，来自于《河流动力学》p74中图3-14
double X_k_m[19] = { 0,1,5,7,10,15,20,30,50,100,200,300,500,600,700,800,1000,2000,3000 };//k、m曲线图横坐标值，即V^3/(gRω)的值
double R_k[19] = { 0,0.01,0.02,0.04,0.1,0.15,0.22,0.33,0.45,0.62,0.9,1.1,1.44,1.6,1.72,1.86,2.08,2.95,3.8 };//k的值
double R_m[19] = { 1.5,1.5,1.46,1.41,1.32,1.08,1.01,0.86,0.75,0.64,0.61,0.58,0.55,0.53,0.51,0.5,0.48,0.4,0.36 };
//由于k、m值采用对数坐标描述，使用时需要先计算V^3/(gRω)的值然后利用X_k_m数组线找出来当前V^3/(gRω)的值在数组中哪两个元素中间，再根据这两个元素的索引号
//去R_k或者R_m中去获得对应的k或m的值
//沉降颗粒粒径mm与沉降速度（m/s）之间的关系
double sedimentP_D[34] = { 0.001,0.005,0.01,0.02,0.05,0.061,0.0687,0.0804,0.0903,0.1,0.123,0.15,0.2,0.225,0.25,0.275,
0.3,0.325,0.375,0.4,0.5,0.55,0.6,0.7,0.75,0.775,0.85,1,1.5,2,2.5,3,3.5,4.5 };
double sedimentP_V[34] = { 0.00000057,0.0000141,0.0000565,0.000223,0.00141,0.00235,0.00292,0.0034,0.00406,0.00515,0.00775,
0.0114,0.017,0.0173,0.0229,0.0299,0.0321,0.0351,0.0418,0.0461,0.058,0.0689,0.0728,0.0804,0.0858,0.1,0.1085,0.12,0.15,0.19,0.21,0.23,0.26,0.285 };
